...
setwd("C:/Users/Ayoola_John/OneDrive/Desktop/R4GIS/Week3") # Change the file path to your working directory
...
# 3. Import/read data -----
b1 <- rast("data/bt_images/Sentinel-2_L2A_B01.tiff")
b2 <- rast("data/bt_images/Sentinel-2_L2A_B02.tiff")
b3 <- rast("data/bt_images/Sentinel-2_L2A_B03.tiff")
b4 <- rast("data/bt_images/Sentinel-2_L2A_B04.tiff")
b5 <- rast("data/bt_images/Sentinel-2_L2A_B05.tiff")
b6 <- rast("data/bt_images/Sentinel-2_L2A_B06.tiff")
b7 <- rast("data/bt_images/Sentinel-2_L2A_B07.tiff")
b8 <- rast("data/bt_images/Sentinel-2_L2A_B08.tiff")
b8a <- rast("data/bt_images/Sentinel-2_L2A_B8A.tiff")
b9 <- rast("data/bt_images/Sentinel-2_L2A_B09.tiff")
b11 <- rast("data/bt_images/Sentinel-2_L2A_B11.tiff")
b12 <- rast("data/bt_images/Sentinel-2_L2A_B12.tiff")
...
ndviMap <- tm_shape(ndvi) + 
  ...
  tm_logo("data/r.png", position = c(0.92, 0.99),height=1)
